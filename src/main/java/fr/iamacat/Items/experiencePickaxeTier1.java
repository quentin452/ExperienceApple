...
public class experiencePickaxeTier1 extends ItemPickaxe{
	public static int count=0;
	public static boolean countF=false;

    public experiencePickaxeTier1(){
    	super(eaMain.TmexperienceIngot);
        setCreativeTab(eaMain.tabAdd)
        .setUnlocalizedName("ExperiencePickaxeTier1")
        .setTextureName("eamod:experiencePickaxe")
        .setMaxStackSize(1);
    }
