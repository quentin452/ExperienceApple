...
public class weakExperienceSword extends ItemSword{
	public static int count=0;
	public static boolean countF=false;

    public weakExperienceSword(){
    	super(Item.ToolMaterial.IRON);
        setCreativeTab(eaMain.tabAdd)
        .setUnlocalizedName("weakExperienceSword")
        .setTextureName("eamod:weakExperienceSword")
        .setMaxStackSize(1);
    }
