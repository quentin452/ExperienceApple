...
public class experienceShovelTier1 extends ItemSpade{
	public static int count=0;
	public static boolean countF=false;

    public experienceShovelTier1(){
    	super(eaMain.TmexperienceIngot);
        setCreativeTab(eaMain.tabAdd)
        .setUnlocalizedName("ExperienceShovelTier1")
        .setTextureName("eamod:experienceShovel")
        .setMaxStackSize(1);
    }
