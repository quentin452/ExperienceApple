...
public class ritualStoneTier1 extends BlockGlass
{
    ...
    public ritualStoneTier1() {
        super(Material.ground,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("RitualStoneTier1");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:ritualStoneTier1");
        this.SideIcon = par1IconRegister.registerIcon("eamod:ritualStoneTier1");
    }
