...
public class ritualStoneTier4 extends BlockGlass
{
    ...
    public ritualStoneTier4() {
        super(Material.ground,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("RitualStoneTier4");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:ritualStoneTier4");
        this.SideIcon = par1IconRegister.registerIcon("eamod:ritualStoneTier4");
    }
