...
public class ritualLauncherTier4 extends BlockGlass implements ITileEntityProvider
{
    ...
    public ritualLauncherTier4() {
        super(Material.ground,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("ritualLauncherTier4");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:ritualLauncherTier4");
        this.SideIcon = par1IconRegister.registerIcon("eamod:ritualLauncherTier4");
    }
