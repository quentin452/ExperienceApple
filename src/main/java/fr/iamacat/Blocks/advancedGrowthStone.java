...
public class advancedGrowthStone extends BlockGlass implements ITileEntityProvider
{
    ...
    public advancedGrowthStone() {
        super(Material.ground,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("advancedGrowthStone");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:advancedGlowthBlock");
        this.SideIcon = par1IconRegister.registerIcon("eamod:advancedGlowthBlock");
    }
