...
public class ritualLauncherTier1 extends BlockGlass implements ITileEntityProvider
{
    ...
    public ritualLauncherTier1() {
        super(Material.ground,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("ritualLauncherTier1");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:ritualLauncherTier1");
        this.SideIcon = par1IconRegister.registerIcon("eamod:ritualLauncherTier1");
    }
