...
public class ritualStoneTier3 extends BlockGlass
{
    ...
    public ritualStoneTier3() {
        super(Material.ground,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("RitualStoneTier3");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:ritualStoneTier3");
        this.SideIcon = par1IconRegister.registerIcon("eamod:ritualStoneTier3");
    }
