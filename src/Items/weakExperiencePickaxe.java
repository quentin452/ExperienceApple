...
public class weakExperiencePickaxe extends ItemPickaxe{
	public static int count=0;
	public static boolean countF=false;

    public weakExperiencePickaxe(){
    	super(Item.ToolMaterial.IRON);
        setCreativeTab(eaMain.tabAdd)
        .setUnlocalizedName("weakExperiencePickaxe")
        .setTextureName("eamod:weakExperiencePickaxe")
        .setMaxStackSize(1);
    }
