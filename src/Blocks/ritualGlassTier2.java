...
public class ritualGlassTier2 extends BlockGlass
{
    ...
    public ritualGlassTier2() {
        super(Material.glass,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("RitualGlassTier2");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:RitualGlass_Tier2");
        this.SideIcon = par1IconRegister.registerIcon("eamod:RitualGlass_Tier2");
    }
