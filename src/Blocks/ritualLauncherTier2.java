...
public class ritualLauncherTier2 extends BlockGlass implements ITileEntityProvider
{
    ...
    public ritualLauncherTier2() {
        super(Material.ground,true);
        this.setCreativeTab(eaMain.tabAdd);
        this.setBlockName("ritualLauncherTier2");
    ...
    {
        this.TopIcon = par1IconRegister.registerIcon("eamod:ritualLauncherTier2");
        this.SideIcon = par1IconRegister.registerIcon("eamod:ritualLauncherTier2");
    }
